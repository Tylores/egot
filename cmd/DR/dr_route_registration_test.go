...
func registerDrRoutes(mux *http.ServeMux, h *handler.Handler) {
	mux.Handle("DELETE /dr", http.HandlerFunc(h.DELETEDrList))
	mux.Handle("DELETE /dr/{id1}", http.HandlerFunc(h.DELETEDr))
	...
	mux.Handle("GET /dr", http.HandlerFunc(h.GETDrList))
	mux.Handle("GET /dr/{id1}", http.HandlerFunc(h.GETDr))
	...
	mux.Handle("HEAD /dr", http.HandlerFunc(h.HEADDrList))
	mux.Handle("HEAD /dr/{id1}", http.HandlerFunc(h.HEADDr))
	...
	mux.Handle("POST /dr", http.HandlerFunc(h.POSTDrList))
	mux.Handle("POST /dr/{id1}", http.HandlerFunc(h.POSTDr))
	...
	mux.Handle("PUT /dr", http.HandlerFunc(h.PUTDrList))
	mux.Handle("PUT /dr/{id1}", http.HandlerFunc(h.PUTDr))
