...
func registerUptRoutes(mux *http.ServeMux, h *handler.Handler) {
	...
	mux.Handle("DELETE /upt/{id1}/mr/{id2}/rt", http.HandlerFunc(h.DELETEReadingTypeList))
	...
	mux.Handle("GET /upt/{id1}/mr/{id2}/rt", http.HandlerFunc(h.GETReadingTypeList))
	...
	mux.Handle("HEAD /upt/{id1}/mr/{id2}/rt", http.HandlerFunc(h.HEADReadingTypeList))
	...
	mux.Handle("POST /upt/{id1}/mr/{id2}/rt", http.HandlerFunc(h.POSTReadingTypeList))
	...
	mux.Handle("PUT /upt/{id1}/mr/{id2}/rt", http.HandlerFunc(h.PUTReadingTypeList))
}
